...
import edu.ucne.eddian_vasquez_ap2_p1.domain.registro.usecase.GetCervezaUseCase
import edu.ucne.eddian_vasquez_ap2_p1.domain.registro.usecase.UpsertCervezaUseCase
...
class CervezaEditViewModel @Inject constructor(
    private val upsertCerveza: UpsertCervezaUseCase,
    ...
    private fun save() {
        viewModelScope.launch {
            ...
            val result = upsertCerveza(cerveza)
